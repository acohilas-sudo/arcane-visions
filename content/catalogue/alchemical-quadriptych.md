...
acquire_heading: "Acquire the Work"
purchase_links:
...
specs: |-
  ...
  Individually signed by Debbi and accompanied by a Certificate of Authenticity
...
The Magnum Opus cannot be captured in a single image. It must be walked through — stage by stage. These four original watercolors by Debbi trace the complete alchemical journey: from the dissolution of base matter to the perfection of the Philosopher's Stone.
...
Artist: Debbi — individually signed
